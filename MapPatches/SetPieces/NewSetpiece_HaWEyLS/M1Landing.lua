...
SetpiecePrgs.M1Landing = function(seed, state, TriggerUnits)
	...
	prgdbg(li, 1, 30) sprocall(SetpieceCamera.Exec, SetpieceCamera, state, rand, false, "", "Max", "", "", "linear", 0, false, false, point(233181, 76750, 16659), point(236828, 73537, 17831), false, false, 4200, 100, false, 0, 0, 0, 0, 0, 0, "Default", 100)
	prgdbg(li, 1, 31) sprocall(SetpieceFadeIn.Exec, SetpieceFadeIn, state, rand, false, "", 0, 2000)
	prgdbg(li, 1, 32) sprocall(SetpieceCamera.Exec, SetpieceCamera, state, rand, true, "", "Max", "", "harmonic", "linear", 10000, false, false, point(233181, 76750, 16659), point(236828, 73537, 17831), point(256029, 169149, 22338), point(260762, 169201, 23950), 4200, 100, false, 0, 0, 0, 0, 0, 0, "Default", 100)
	prgdbg(li, 1, 33) sprocall(SetpieceFadeOut.Exec, SetpieceFadeOut, state, rand, true, "", 1700)
	prgdbg(li, 1, 34) sprocall(SetpieceCamera.Exec, SetpieceCamera, state, rand, true, "", "Tac", "", "", "linear", 0, false, false, point(256029, 169149, 22338), point(260762, 169201, 23950), false, false, 4200, 1300, false, 0, 0, 0, 0, 0, 0, "Default", 100)
end