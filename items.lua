return {
	...
	West = false,
			...
			PlaceObj('ModItemSector', {
				'comment', "«Дизельклиника»",
				'mapName', "m3YqaH",
				'campaignId', "HotDiamonds",
				'sectorId', "A25_Underground",
				'SatelliteSectorObj', PlaceObj('SatelliteSector', {
					'Id', "A25_Underground",
					'Map', "m3YqaH",
					'MapTier', 30,
	...
	West = false,
		...
		PlaceObj('ModItemFolder', {
			...
			PlaceObj('ModItemSector', {
				'comment', "Часть острова рядом с крепостью вояк",
				'mapName', "TqfCXg",
				'campaignId', "HotDiamonds",
				'sectorId', "L18",
				'SatelliteSectorObj', PlaceObj('SatelliteSector', {
	...
	South = false,
			...
			PlaceObj('ModItemSector', {
				'comment', "Часто маленького острова",
				'mapName', "aybsyQm",
				'campaignId', "HotDiamonds",
				'sectorId', "L12",
				'SatelliteSectorObj', PlaceObj('SatelliteSector', {
